export declare const OrthogonalOrdering: {
    Original: import("../interfaces").Criteria<"oo_o", "orthogonal-ordering/original">;
    NumberInversions: import("../interfaces").Criteria<"oo_ni", "orthogonal-ordering/number-of-inversions">;
    NormalizedNumberInversions: import("../interfaces").Criteria<"oo_nni", "orthogonal-ordering/normalized-number-of-inversions">;
